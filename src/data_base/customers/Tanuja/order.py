...
# Mock function to simulate loading menu data (you should replace this with your actual data source)
def load_menu():
    return [
        {"name": "Pizza", "price": 300, "half_price": 200, "availability": True},
        {"name": "Burger", "price": 150, "availability": True},
        {"name": "Pasta", "price": 250, "half_price": 150, "availability": True},
        {"name": "Salad", "price": 120, "availability": False}
    ]

# Mock function to simulate loading all invoices (you should replace this with your actual data source)
def load_all_invoices_of_an_user(directory):
    # For now, we return some mock invoices
    return [
        {
            "order_id": "401-1234-5678",
            "date": "2024-10-15",
            "time": "14:30",
            "customer_details": {
                "name": "JohnDoe",
            ...
            "items": [
                {"name": "Pizza", "quantity": 2, "price_per_unit": 300, "total_price": 600},
                {"name": "Burger", "quantity": 1, "price_per_unit": 150, "total_price": 150}
            ],
            "sub_total": 750,
            "gst_amount": 135,
            "grand_total": 885,
...
# Helper function to show loading (this was missing in your original code)
def loading():
    print("Loading...")

class Order:
    def __init__(self, user):  # Fixed the typo here
        self.user = user
        self.orders = []
        self.menu = load_menu()
        self.gst_rate = 0.18
    ...
    def view_ongoing_order(self):
        ...
        directory = f'src/data_base/customers/{user_directory}/'
    ...
    def payment_history(self):
        ...
        if len(invoices_list) != 0:
            print(f"{'Payment Mode':<20} {'Order ID':<40} {'Date & Time':<25} {'Total Payment'}")
            print("-"*110)
            for invoice in invoices_list:
...
def main():
    user = {
        "id": "123",
        "username": "tanuja12",
        "user_email": "gariyatanu68@gmail.com",
        "role": "customer"
    }
    ...
    while True:
        print("\nMenu:")
        print("1. Take Order")
        print("2. View Ongoing Orders")
        print("3. Cancel Order")
        print("4. Payment History")
        print("5. View Invoice")
        print("0. Exit")
